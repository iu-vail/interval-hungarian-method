...
///////////////////////////////////////////////////////////////////////////////
// File name: test.cpp
// Just for testing, the Hungarian algorithm is splitted into step-units.
...
void testMatrixCopy(void){
  ...
  cout<<"original value for copy m2(0, 1):"<<endl;
  cout<<m2[0][1]<<endl;
  m2[0][1] +=1;
  
  cout<<"m2(0, 1) increases 1: "<<endl;
  cout<<m2[0][1]<<endl;

  cout<<"m1(0, 1) w/o change but current value:"<<endl;
  cout<<m1[0][1]<<endl;
